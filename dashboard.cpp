...
void Dashboard::drawFrame()
{
  ...
  drawPump(FUEL_CIRCLE_CENTER_X + 4, FUEL_CIRCLE_CENTER_Y + 6, TFT_WHITE);
  ...
  drawPump(ADBLUE_CIRCLE_CENTER_X + 4, ADBLUE_CIRCLE_CENTER_Y + 6, TFT_SKYBLUE);
